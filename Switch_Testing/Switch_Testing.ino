//const int buttonPin = 4; // the input pin for the button
...
////const int buttonPin = 4;  // the input pin for the button
////int buttonState = 0;      // variable for reading the button state
////boolean toggleState = false; // variable for storing the toggle state
////
////void setup() {
////  pinMode(buttonPin, INPUT); // set the button pin as an input
...
////    delay(50); // debounce the button by waiting for a short period of time
////    if (buttonState == HIGH) { // check if the button is still pressed
////      toggleState = !toggleState; // toggle the state variable
////      
////      if (toggleState) { // perform the action associated with the "on" state
////        Serial.println("Toggle switch is ON");
////        // code for the "on" state
////      } else { // perform the action associated with the "off" state
